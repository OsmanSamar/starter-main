...
// Run the server by going to the directory that contains your JSON file using the terminal and enter the following command:
...
export const loader = async () => {
  ...
  // Log the events and categories to the console
